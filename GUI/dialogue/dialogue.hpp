...
//--- position helpers
#define LISTBOX_X CENTER(1,(LISTBOX_W))
#define QLISTBOX_Y (CENTER(1,(0.70 * Y_SCALE)))
#define ALISTBOX_Y (CENTER(1,(-0.40 * Y_SCALE)))
#define TEXT_LEFT_X   (CENTER(1,(1.0 * LISTBOX_W)))
#define TEXT_RIGHT_X  ((CENTER(1,(-1.0 * LISTBOX_W))) - TEXT_W)
