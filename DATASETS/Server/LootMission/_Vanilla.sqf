...
[
	...
	[
		["ANYFAC","-SHOP","ANYVEH","LOOT","RUG"],[
			[],
			[],
			["FirstAidKit","FirstAidKit","Binocular","ChemicalDetector_01_watch_F","ItemCompass","ItemGPS","ItemMap","ItemRadio","ItemWatch"],
			[]
		]
	],
	[
	...
	/*Junk underbarrel*/
	[
		["ANYFAC","-SHOP","-CIV","ANYVEH","LOOT","WEAP"],[
			[],
			[],
			[],
