NWG_LocalizationDictionary = createHashMapFromArray [
    ...
    ["#QST_QD_INFECTION_01#","There's a new desease spreading|As I understand...|Our adversaries are quarantining people|And they have no idea what to do next|But we can help them here and now|As we should"],
    ...
    ["#QST_QD_TERMINAL_01#","Enemy. UAV. And Terminals|You bring here - bring - I pay money|Good money|Oh, sorry, I thought you don't speak English|Anyway, yeah, I need some terminals for... purposes|Just get me some, would ya?|And don't tell anyone|I'll pay"],
    ["#QST_QD_TERMINAL_02#","Hey, are you heading on a mission?|Say, if you find some enemy UAVs or terminals|You may want to show them to me instead of just selling|Just saying|Maybe I'll drop some cash|You know?"],
    ["#QST_QD_TERMINAL_03#","Yo, you're going on a mission by any chance?|Wanna earn some?|I'm looking for some... UAVs and UAV terminals|You know...|The stuff *I* know|That I can fix and put a price tag on it|(mumbling:) better than this mech asshole...|Get me some and I'll share some|All right?"],
    ...
    ["#QST_QD_TOOLS_01#","Hey, boss|I'm looking for some tools|You know...|Want to cut some spendings and fix things with my own hands|Could you bring me some?"],
    ["#QST_QD_TOOLS_02#","This mech guy always like...|'Waa waa, don't touch my tools without permission'|So I thought|Why won't I just buy some for myself?|And why won't I buy it from you?|Won't have to ask every god damn time|Will you bring some?"],
    ["#QST_QD_TOOLS_03#","Hey, boss|If you'll find some tools out there|Would you mind bringing them here instead of selling?|Oh, I'll pay, don't worry about that"],
    /*Quest answers*/
