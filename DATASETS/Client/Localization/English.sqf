NWG_LocalizationDictionary = createHashMapFromArray [
    ...
    ["#TAXI_HELP_USERFLOW_Q_01#","Quite simple, just tell me where to drop you off|I'll calculate the price and do my best to get you there at no time|As for getting back...|You should figure it out yourself|Sorry, boss, but I don't get into the heat free of charge|And that is exactly what bossman inside wants me to do|He said, if you guys need emergency evac - I do that and don't ask for money|But I'm not complaining, I'm just saying|You need to seek for opportunities|So I won't take your money for that|But I'll take about half of what you have in stash|I have to be compensated, right? Fuel ain't free so as my services|It's only fair and doesn't break any rules, right, boss?|...|Oh, and one more thing I almost forgot - I promise to get YOU back|I don't guarantee your equipment will make it|Lost, stuck, was too heavy - no offense and no hard feelings, okay?"],
    /*Taxi - TAXI_ADV*/
    ...
    ["#MECH_ADV_Q_03#","Don't get greedy|If you see you need to sacrifice your ride|Do it|You can always get a new one|It is better to lose some additionals|Than half of what you got so far|(nods toward taxi stand)"],
    ...
    ["#TRDR_HELP_PLACE_Q_01#","Look around, this is my shop. This is where the money are made|And other there is your storage, you can check it out before selling things to me|Everything you get from outside goes to this box|And if you want to sell something that's on you at the moment|You should put it there"],
    /*Trdr - TRDR_HELP_WHO*/
    ...
    ["#COMM_HELP_PLACE_Q_01#","This is our field operation center|Here we gather all the information and make plans on where to go next"],
    /*Comm - COMM_HELP_WHO*/
    ...
    /*Roof - ROOF_LGND_BIT*/
    ["#ROOF_LGND_BIT_Q_01#","No, Rayman is another guy|But that Bit-Ramon?|Fucking lunatic|Would crash his heli into the building|Just to get there a 'Bit' faster|And knife out everyone inside|We thought he and MoshPit were the most badass motherfuckers out there|And were kinda expecting them to meet to settle the score|Turns out|It was all the same guy|Fucking both sides|Just for shit and giggles|Oh, and a fuck load of money of course"],
