...
NWG_AI_TC_SetupCampFire = {
	...
	private _title = "#AI_CAMP_TO_BASE_TITLE#";
...
NWG_AI_TC_ToBase = {
	...
	private _price = ((((round ((player distance _teleportTo) / 1000))) * (NWG_DLG_TAXI_Settings get "PRICE_CMP_KM")) + (NWG_DLG_TAXI_Settings get "PRICE_CMP_RAW"));
