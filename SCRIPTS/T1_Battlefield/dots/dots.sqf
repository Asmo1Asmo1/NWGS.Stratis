...
NWG_DOTS_Settings = createHashMapFromArray [
    ...
    ["AREA_AIR_HEIGHT",[175,200,225,250,275,300,325]],//Height that would be randomly assigned as a z coordinate for air spawn points

    ["TRIGGER_SPAWNSEARCH_SETTINGS_MULTIPLIER",1],//Multiplier for AREA_SPAWNSEARCH settings for trigger markup (leave it 1)
    ["TRIGGER_LOCATIONS_RADIUS",[100,200]],//Radius outside trigger to search for locations (_triggerRad + TRIGGER_LOCATIONS_RADIUS)
    ["TRIGGER_LOCATIONS_MINBETWEEN",150],//Min distance between locations in trigger markup
    ["TRIGGER_ROADS_RADIUS",[200,350]],//Radius outside trigger to search for roads in trigger markup
    ["TRIGGER_AIR_RADIUS",350],//(Max) radius outside trigger to markup air spawn points
